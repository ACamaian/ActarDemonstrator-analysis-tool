...
namespace ROOT {
   static void *new_cHit(void *p = nullptr);
   ...
   {
      ::cHit *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::cHit >(nullptr);
   ...
   {
      return GenerateInitInstanceLocal((::cHit*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::cHit*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

//______________________________________________________________________________
atomic_TClass_ptr cHit::fgIsA(nullptr);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::cHit*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int cHit::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::cHit*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *cHit::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::cHit*)nullptr)->GetClass();
   return fgIsA;
}
...
TClass *cHit::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::cHit*)nullptr)->GetClass(); }
   return fgIsA;
}
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("cHitDict",
        ...
        TriggerDictionaryInitialization_cHitDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
