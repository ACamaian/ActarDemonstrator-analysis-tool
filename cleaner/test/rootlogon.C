void rootlogon()
{
  ...
  //load .so for ARDA
  gSystem->Load("/home/buccola/ats/arda/libMFM/libMFM.so");  
  gSystem->Load("/home/buccola/ats/arda/pClasses/libpClasses.so"); 
  gSystem->Load("/home/buccola/ats/arda/libARDAlib.so"); 
  
  printf("--ARDA  Done. --\n");
    
  //tools for analysis
  gROOT->ProcessLine(".L /home/camaiani/ATS_perdite/src/cHitxyz.cc+");
  gROOT->ProcessLine(".L /home/camaiani/ATS_perdite/src/cEvent.cc+");
