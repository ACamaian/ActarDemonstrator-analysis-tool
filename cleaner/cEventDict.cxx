...
namespace ROOT {
   static void *new_cEvent(void *p = 0);
   ...
   {
      ::cEvent *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::cEvent >(0);
   ...
   {
      return GenerateInitInstanceLocal((::cEvent*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::cEvent*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

//______________________________________________________________________________
atomic_TClass_ptr cEvent::fgIsA(0);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::cEvent*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int cEvent::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::cEvent*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *cEvent::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::cEvent*)0x0)->GetClass();
   return fgIsA;
}
...
TClass *cEvent::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::cEvent*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static void *new_vectorlEcHitxyzgR(void *p = 0);
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<cHitxyz>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEcHitxyzgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<cHitxyz>*)0x0)->GetClass();
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("cEventDict",
        ...
        TriggerDictionaryInitialization_cEventDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
